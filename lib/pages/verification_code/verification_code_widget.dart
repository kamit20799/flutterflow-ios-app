...
class VerificationCodeWidget extends StatefulWidget {
  ...
  static String routeName = 'VerificationCode';
                              ...
                              onPressed: () async {
                                if (_model.textController.text != '') {
                                  _model.userLoginResponse =
                                    ...
                                    phoneNumber: FFAppState().MobileNumber,
                                    verificationCode:
                                        _model.textController.text,
                                  );

                                  if ((_model.userLoginResponse?.succeeded ??
                                      true)) {
                                    FFAppState().token = valueOrDefault<String>(
                                      getJsonField(
                                        (_model.userLoginResponse?.jsonBody ??
                                            ''),
                                        r'''$.data.token''',
                                      )?.toString(),
                                      '\$.data.token',
                                    ...
                                    ScaffoldMessenger.of(context).showSnackBar(
                                      SnackBar(
                                        content: Text(
                                          'Verfication code is wrong, please enter correct one.',
                                          style: TextStyle(
                                            fontFamily: 'Onest',
                                            color: FlutterFlowTheme.of(context)
                                                .secondaryBackground,
                                  ...
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content: Text(
                                        'Enter your verfication code to login.',
                                        style: TextStyle(
                                          fontFamily: 'Onest',
                                          color: FlutterFlowTheme.of(context)
                                              .secondaryBackground,
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  _model.resendOtpResponse =
                                    ...
                                    phoneNumber: FFAppState().userPhone,
