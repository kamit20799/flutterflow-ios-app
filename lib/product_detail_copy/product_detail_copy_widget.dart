...
class ProductDetailCopyWidget extends StatefulWidget {
  ...
  static String routeName = 'productDetailCopy';
  static String routePath = '/productDetailCopy';
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final productDetailCopyProductDetailAPIResponse = snapshot.data!;
                        ...
                        child: Column(
                          ...
                          children: [
                            Padding(
                              ...
                              child: Hero(
                                tag: getJsonField(
                                  productDetailCopyProductDetailAPIResponse
                                      .jsonBody,
                                  r'''$.data.image_url''',
                                ).toString(),
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  if (FFAppState().cartId == '') {
                                    ...
                                    if ((_model.updateCartResponse?.succeeded ??
                                        true)) {
                                      ScaffoldMessenger.of(context)
                                          .showSnackBar(
                                        SnackBar(
